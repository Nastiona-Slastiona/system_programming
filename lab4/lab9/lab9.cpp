...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    bmp[0] = LoadImage(NULL, L"1.bmp", IMAGE_BITMAP, 40, 40, LR_LOADFROMFILE);
    bmp[1] = LoadImage(NULL, L"2.bmp", IMAGE_BITMAP, 48, 48, LR_LOADFROMFILE);
    bmp[2] = LoadImage(NULL, L"3.bmp", IMAGE_BITMAP, 50, 50, LR_LOADFROMFILE);
    bmp[3] = LoadImage(NULL, L"4.bmp", IMAGE_BITMAP, 60, 60, LR_LOADFROMFILE);
